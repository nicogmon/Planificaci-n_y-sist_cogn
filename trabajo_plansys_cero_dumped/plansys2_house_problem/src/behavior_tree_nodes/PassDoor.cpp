...
#include "plansys2_house_problem/behavior_tree_nodes/PassDoor.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<plansys2_house_problem::PassDoor>(
        name, "navigate_to_pose", config);
    };

  factory.registerBuilder<plansys2_house_problem::PassDoor>(
    "PassDoor", builder);
}
