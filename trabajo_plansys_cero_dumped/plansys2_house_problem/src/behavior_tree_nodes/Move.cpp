...
#include "plansys2_house_problem/behavior_tree_nodes/Move.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<plansys2_house_problem::Move>(
        name, "navigate_to_pose", config);
    };

  factory.registerBuilder<plansys2_house_problem::Move>(
    "Move", builder);
}
